...
if __name__ == '__main__':
    ...
    # @ Jinyu Zhang
    # model = SwinIR(upscale=4, img_size=(128, 128),
    #     window_size=8, img_range=1., depths=[6, 6, 6, 6, 6],
    #     embed_dim=72, num_heads=[6, 6, 6, 6, 6], mlp_ratio=4, upsampler='pixelshuffledirect')

    model = SwinIR_cus(upscale=3, img_size=(128, 128), window_size=8, img_range=1., in_chans=1,
